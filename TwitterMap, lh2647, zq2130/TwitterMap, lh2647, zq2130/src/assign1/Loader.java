	...
	public static void main(String[] args) throws TwitterException, IOException, JSONException {
		  ...
		  public static void stream() throws TwitterException, IOException, JSONException{
		       ...
		       public void onStatus(Status status) {
		            ...
		            if(geoLocation!=null){
		            	String itemIndex =((Integer)(twitterNum)).toString();
		            	...
		            	twitterNum++;
		            	if (twitterNum>10) {
		            		sdb.deleteDomain(new DeleteDomainRequest("Twitter"));
		            		sdb.createDomain(new CreateDomainRequest("Twitter"));
		            		System.out.println("------------------------------------");
		            		System.out.println("times:"+flushTimes);
		            		System.out.println("------------------------------------");
		            		flushTimes++;
		            		twitterNum=0;
		            	}
